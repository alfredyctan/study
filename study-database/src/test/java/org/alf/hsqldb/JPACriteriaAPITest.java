...
public class JPACriteriaAPITest {
	...
	public void testGetById() throws SQLException {
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("/user-dao-jpa.xml");
	...
	public void testModifyByIdRange() throws SQLException {
		...
		userDAO.modifyUsersByIdRange(1, 2, JPAUser_.name, "Alftank");
		
		users = userDAO.getUsersByIdRange(0, 10);
		System.out.println("after modify user name:" + users);
		
		userDAO.modifyUsersByIdRange(1, 2, JPAUser_.email, "char@yahoo.com.hk");
		users = userDAO.getUsersByIdRange(0, 10);
